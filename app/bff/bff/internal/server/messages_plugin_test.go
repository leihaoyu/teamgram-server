...
<meta name="description" content="Meta description here" />
	...
	t.Log("parseOGMeta_FallbackTitle: PASS")
}
...
<meta property="og:title" content="OG Title" />
	...
	// og:title should be preferred — <title> sets og.Title="" first, then og:title overwrites
	// Actually, <title> comes first and sets og.Title="Fallback", then og:title overwrites to "OG Title"
...
func TestParseOGMeta_EmptyHTML(t *testing.T) {
	...
	t.Log("parseOGMeta_EmptyHTML: PASS")
}
...
<meta property="og:description" content="Should Not Be Parsed" />
	...
	t.Log("parseOGMeta_StopsAtBody: PASS")
}
...
<meta property="og:site_name" content="新闻网" />
	...
	t.Log("parseOGMeta_ChineseContent: PASS")
}
...
func TestIsPrivateHost(t *testing.T) {
	...
	t.Log("isPrivateHost: PASS")
}

func TestParseOGMeta_RealWorldLike(t *testing.T) {
	// Simulates a typical YouTube-like page
	htmlContent := `<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<body>lots of content here</body>
	...
	t.Logf("parseOGMeta_RealWorldLike: PASS (title=%q, site=%q, type=%q)", og.Title, og.SiteName, og.Type)
}
