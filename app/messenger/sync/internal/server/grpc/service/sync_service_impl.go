...
func (s *Service) SyncUpdatesMe(ctx context.Context, request *sync.TLSyncUpdatesMe) (*mtproto.Void, error) {
	...
	c.Logger.Debugf("sync.updatesMe - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("sync.updatesMe - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) SyncUpdatesNotMe(ctx context.Context, request *sync.TLSyncUpdatesNotMe) (*mtproto.Void, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("sync.updatesNotMe - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("sync.updatesNotMe - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) SyncPushUpdates(ctx context.Context, request *sync.TLSyncPushUpdates) (*mtproto.Void, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("sync.pushUpdates - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("sync.pushUpdates - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) SyncPushUpdatesIfNot(ctx context.Context, request *sync.TLSyncPushUpdatesIfNot) (*mtproto.Void, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("sync.pushUpdatesIfNot - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("sync.pushUpdatesIfNot - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) SyncPushBotUpdates(ctx context.Context, request *sync.TLSyncPushBotUpdates) (*mtproto.Void, error) {
	...
	c.Logger.Errorf("sync.pushBotUpdates - method not impl.")
...
func (s *Service) SyncPushRpcResult(ctx context.Context, request *sync.TLSyncPushRpcResult) (*mtproto.Void, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("sync.pushRpcResult - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("sync.pushRpcResult - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) SyncBroadcastUpdates(ctx context.Context, request *sync.TLSyncBroadcastUpdates) (*mtproto.Void, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("sync.broadcastUpdates - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("sync.broadcastUpdates - reply: %s", r.DebugString())
	return r, err
}
